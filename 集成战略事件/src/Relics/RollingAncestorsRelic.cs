...
public sealed class RollingAncestorsRelic : IntegratedStrategyEventRelic
{
	private const decimal ArtifactAmount = 2m;

	private bool _appliedThisCombat;

	public RollingAncestorsRelic()
		: base("rolling_ancestors.png")
	{
	}
	...
	public override Task AfterSideTurnStart(CombatSide side, IReadOnlyList<Creature> participants, ICombatState combatState)
	{
		...
		Flash();
		return PowerCmd.Apply<ArtifactPower>(enemies, ArtifactAmount, owner.Creature, null);
	}
}
